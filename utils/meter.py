...
class Meter_v2():
    ...
    def roc_auc_score(self, reduction='none'):
        ...
        return roc_auc_score(y_true.long().numpy(), y_pred_numpy.numpy())
    ...
    def f1_score(self, reduction='none'):
        ...
        return f1_score(y_true.long().numpy(), y_pred_round.numpy(), zero_division=0)
    ...
    def precision_score(self, reduction='none'):
        ...
        y_pred_numpy = torch.sigmoid(y_pred).numpy()
        y_pred_round = torch.FloatTensor(np.around(y_pred_numpy)) * (mask != 0).float()
        return precision_score(y_true.long().numpy(), y_pred_round.numpy(), zero_division = 0)
    ...
    def recall_score(self, reduction='none'):
        ...
        y_pred_numpy = torch.sigmoid(y_pred).numpy()
        y_pred_round = torch.FloatTensor(np.around(y_pred_numpy)) * (mask != 0).float()
        return recall_score(y_true.long().numpy(), y_pred_round.numpy(), zero_division=0)
    ...
    def confusion_matrix(self):
        ...
        y_pred_numpy = torch.sigmoid(y_pred).numpy()
        y_pred_round = torch.FloatTensor(np.around(y_pred_numpy)) * (mask != 0).float()
        return confusion_matrix(y_true.long().numpy(), y_pred_round.numpy())
